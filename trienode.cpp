...
//we can also allocate trienodes dynamically
void init() //Initializer function
{
	//can also do by constructor
    poolcount = 0;
...
Trienode *getNode(char c)//used to make a node with given node data and declaring all childs null
{
